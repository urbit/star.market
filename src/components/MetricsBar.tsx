  ...
  const renderContent = () => {
    ...
    return (
      <>
        ...
        <>
          <Box>${formatNumber(starPrice?.["last_sale_usd"] ?? 0)}</Box>
        ...
        <div className="remove-when-reduced-2">
          ...
          <Box>{starPrice?.["last_sale_eth"] ?? 0} ETH</Box>
          <Box
            style={{
              marginLeft: 10,
              color: getColor(
        ...
        <div className="remove-when-reduced">
          <Box className="metrics-label">Fully Diluted Market Cap.</Box>
          <Box>
            ${formatNumber((starPrice?.["avg_current_week_usd"] ?? 0) * 65280)}
          </Box>
        </div>
            ...
            <Box className="message-container">
              <Text>
                ...
                <ul>
                  ...
                  <li>
                    <b>% Chg: </b>Most recent sale on OpenSea compared to the
                    previous week's average price.
                  </li>
                  <br />

                  <li>
                    <b>Fully Diluted Market Cap: </b>Current week's average
                    price * 65,280 stars.
                  </li>
                </ul>

                <p>Please note that some delay may be present in reporting.</p>
              </Text>
            </Box>
          </Modal>
        )}
